...
// pantalla - body
document.write(name);
document.getElementById("box_one").innerHTML = "<h1>Steeven Chacón</h1>"; // cuando uso innerHTML identificador de texto
document.getElementById("box_two").innerText = "<h1>Steeven Chacón</h1>";
//librerias
Swal.fire({
    icon : 'info',
    title: 'Steeven',
...
let array_mul = [
    {name:"Alex", last_name: "Chacon", age: "3"},
    {name:"Ariana", last_name: "Parada", age: "3"},
    {name:"Steeven", last_name: "Chacon", age: "3"},
    {name:"Evans", last_name: "Parada", age: "3"},
];
